...
public class LIFXPacketFrameAddress{
    ...
    public static final String reservedBitsOne = "000000000000000000000000000000000000000000000000";    /** Reserved 48 bits                                                | 48 bits **/
    public static final String reservedBitsTwo = "000000";                                              /** Reserved 6 bits                                                 | 6 bits **/
